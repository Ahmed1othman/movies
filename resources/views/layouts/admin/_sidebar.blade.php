...
<aside class="app-sidebar">
    {{--user info--}}
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{auth()->user()->image_path}}" alt="User Image">
        <div>
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{request()->is('*roles*')? 'active': ''}}" href="{{route('admin.roles.index')}}"><i class="app-menu__icon fa fa-th-list   "></i><span class="app-menu__label">@lang('roles.roles')</span></a></li>
        @endif
