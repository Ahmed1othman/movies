            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('admin.users.update', $user->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="description" autofocus class="form-control">{{ old('name', $user->description)}} </textarea>
                    </div>

                    <h5>@lang('users.permissions') <span class="text-danger">*</span></h5>

                    @php
                        $models = ['users', 'admins','users','settings'];
                    @endphp

                    <table class="table">
                        <thead>
                        <tr>
                            <th>@lang('users.model')</th>
                                ...
                                <td>
                                    ...
                                    @foreach ($permissionMaps as $permissionMap)
                                        <div class="animated-checkbox mx-2" style="display:inline-block;">
                                            <label class="m-0">
                                                <input type="checkbox" value="{{ $permissionMap . '_' . $model }}" name="permissions[]" {{ $user->hasPermission( $permissionMap . '_' . $model) ? 'checked' : '' }} class="user">
