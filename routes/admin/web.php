...
Route::middleware([
    ...
    ->group(function(){
            Route::name('admin.')->prefix('admin')->group(function (){
                ...
                Route::put('/admins/update_status/{user}', 'AdminController@updateStatus')->name('admins.update_status');
                ...
                Route::put('/users/update_status/{user}', 'UserController@updateStatus')->name('users.update_status');
